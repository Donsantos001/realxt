...
class FeaturedDetail extends StatefulWidget {
  final int index;
  const FeaturedDetail({super.key, required this.index});

  @override
  State<FeaturedDetail> createState() => _FeaturedDetailState();
}

class _FeaturedDetailState extends State<FeaturedDetail> {
  bool _liked = false;
